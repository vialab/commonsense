<?
    ...
    $query = "SELECT `SELECTED`, ACTORS.ACTOR_ID, ACTORS.NAME AS ACTOR_NAME, ASSETS.NAME AS ASSET_NAME, ASSET_TYPES.NAME AS ASSET_TYPE_NAME, GRAPH_X, GRAPH_Y, X, Y, Z, RZ, ATTRIBUTES.ATTRIBUTE_ID AS ATTRIBUTE_ID, ATTRIBUTE_TYPES.NAME AS ATTRIBUTE_TYPE_NAME, ATTRIBUTES.ATTRIBUTE_TYPE_ID, `LABEL`, `VALUE`, I0.* FROM ACTORS
